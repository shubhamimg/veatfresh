...
class CrudModel
{
    ...
    public function getAnyItems($db_data)
    {
        ...
        if(isset($db_data['group_by'])){
            $builder->groupBy($db_data['group_by']['column']);
        }
    ...
    public function countTotalRowsAll($table, $where)
    {
        $count_query = "SELECT COUNT(*) as total FROM " . $table;
    ...
    public function getRelationItems($table, $where, $orderField = null, $orderDirection = null)
    {
