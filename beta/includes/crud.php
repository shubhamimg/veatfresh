...
define('DOMAIN_URL','https://veatfresh.in/beta/'); /* chnage to your domain here replace_with_your_strong_jwt_secret_key*/
define('JWT_SECRET_KEY','sonampnb3377@12345.com'); /*chnage to your secret key here replace_with_your_strong_jwt_secret_key*/
...
class Database{
    ...
    private $db_user = "veatfresh_user";  // wrteamin_user Change as required wrteamin_user
    private $db_pass = "veatfresh@2020";  // wrteam@0124 Change as required wrteam@0124
    private $db_name = "veatfresh";    // Change as required
