    ...
    if(!empty($name) && !empty($category_id) && !empty($serve_for) && empty($error['image']) && empty($error['other_images']) && !empty($description)){
			...
			if($_POST['type']=='packet'){
			    for($i=0;$i<count($_POST['packate_measurement']);$i++){
                    ...
                    $gross_weight=$db->escapeString($_POST['packate_gross_weight'][$i]);
					$no_of_pieces=$db->escapeString($_POST['packate_pieces'][$i]);
					$no_of_persons=$db->escapeString($_POST['packate_persons'][$i]);


					
                    $sql="INSERT INTO product_variant (product_id,type,measurement,measurement_unit_id,price,discounted_price,serve_for,stock,stock_unit_id,gross_weight,no_of_pieces,no_of_persons) VALUES('$product_id','$type','$measurement','$measurement_unit_id','$price','$discounted_price','$serve_for','$stock','$stock_unit_id','$gross_weight','$no_of_pieces','$no_of_persons')";
                     $db->sql($sql);
                    ...
                    <div class="box-body">
						...
						<div id="packate_div" style="display:none">
							<div class="row">
								...
								<div class="col-md-2">
							        <div class="form-group packate_div">
	                                    <label for="exampleInputEmail1">Gross Weight</label><input type="text" class="form-control" name="packate_gross_weight[]" required />
	                                </div>
	                            </div>
                            	...
                            	<div class="col-md-2">
								 ...
								 <div class="col-md-2">
							        <div class="form-group packate_div">
	                                    <label for="exampleInputEmail1">No.Of Pieces</label><input type="text" class="form-control" name="packate_pieces[]" />
	                                </div>
	                             </div>
								 <div class="col-md-2">
							        <div class="form-group packate_div">
	                                    <label for="exampleInputEmail1">No.Of Person</label><input type="text" class="form-control" name="packate_persons[]" />
	                                </div>
	                             </div>
                            	<div class="col-md-1">
