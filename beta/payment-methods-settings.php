                            ...
                            <div class="box-body">
                                <div class="col-md-4">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <hr>
                                        <div class="form-group">
                                            <label for="cash_payment_method">Cash Payments <small>[ Enable / Disable ] </small></label><br>
                                            <input type="checkbox" id="cash_payment_method_btn" class="js-switch" <?php if(!empty($data['cash_payment_method']) && $data['cash_payment_method'] == '1'){ echo 'checked'; }?>>
                                            <input type="hidden" id="cash_payment_method" name="cash_payment_method" value="<?=(isset($data['cash_payment_method']) && !empty($data['cash_payment_method']))?$data['cash_payment_method']:0;?>">
...
<script type="text/javascript">
	...
	var changeCheckbox4 = document.querySelector('#cash_payment_method_btn');
		...
		/* cash pay change button value */
        changeCheckbox4.onchange = function() {
            if(changeCheckbox4.checked)
                $('#cash_payment_method').val(1);
            else
                $('#cash_payment_method').val(0);
        };
